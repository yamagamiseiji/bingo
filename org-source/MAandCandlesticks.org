...
#           Time-stamp: <2022-02-04 13:23:12 yamagami>
...
始めたら あちこちに落とし穴（「[[#kabe]]」節）があって、けっこうハマりました :sweat: 

しかし、なんとか図[[fig1]]のような図が描けるようになりました。
ある会社のおよそ１年間の株価データをプロットして見ました。
#+caption: Gnuplotで描いたローソク足と25日,75日移動平均
#+name: fig1
#+attr_html: :width 100%
[[file:yatta-1.png]]

図[[fig2]]は 図[[fig1]]の一部を拡大表示したものです。
...
あと、移動平均の日数(窓サイズ)は、国によってさまざま[fn:window]ですが、ここではわが国で一般的に採用されている短期＝25日、長期＝75日としました。

[fn:window] 移動平均の日数は、各国の株式市場の営業日などの事情で変わってくるようです。[[https://www.investopedia.com/ask/answers/122414/what-are-most-common-periods-used-creating-moving-average-ma-lines.asp][Investopedia]]によれば、もっとも一般的なのは *5, 10, 20, 50日* だそうです。
 ...
 *(2020/02/04 追記)* EquiVolumeはわりに簡単にできました。「[[https://bred-in-bingo.netlify.app/posts/boxwidth-candlesticks/][gnuplotでローソク足の箱幅を出来高に応じて変える]] 」をご覧ください。
