...
これに **散水ノズルスタンド** を取りつけると図[2](#org930faaa)のようになります。これで作業はおわりです。<span style="color: red">赤丸</span>についての説明は「[散水ノズルスタンド](#散水ノズルスタンド)」節をみてください。
...
| 採集コンテナx2 | 図[3](#orgf53fe9b) のような農業用コンテナ                                                                                                 |
...
最大の **ミソ** はIKEAのFYNDIGシンクが図[3](#orgf53fe9b)の採集コンテナに **ぱこっ** とはまること。ほぼあつらえたようなハマり具合です(注[^fn:3]):smile:<br />
...
簡単な仕掛けですが、これがあるのと無いのとでは使い勝手が大ちがいです。なお採集コンテナは **板厚** が薄いので、図[2](#org930faaa)の
