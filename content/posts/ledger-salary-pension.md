...
-   Ledgerでは、貸方・借方の概念を前提とせず[^fn:3]、 **アカウント** （account; 勘定科目）ベースで複式簿記の **原理** を具現化しています。
