...
図[1](#orgc170131)が外観です。基本はふつうのペットボトルベースのトラップですが、ポイントが2点あります。
...
図[1](#orgc170131)だけでおよその作り方はお分かりいただけると思いますが、詳しくは「[（参考資料）一方向ドアつきトラップの作り方](#sanko-siryo)」節をごらんください。
...
2.  **墨付け** ：上の型紙を使って油性マジックで入口を墨付けします（図[3](#orgb79f1e4)）。入口（三箇所）の場所決めのために、ペットボトルの胴回りと同じ長さの **ヒモ** を用意し、3等分した箇所にマジックで印をつけておくと作業が楽。なお型紙に **上下のマーク** があるのは、下のラインをペットボトルのラベル貼り付け用の段差ラインにそろえるため。

    <a id="orgb79f1e4"></a>

    {{< figure src="/trap-step1.jpg" caption="&#22259;3:  ３箇所に入口用の墨付けをする" width="50%" >}}

3.  **カッティング** ：カッターで入口を切り抜きます。切り抜いたパーツ（図[4](#org6d9b1f9) の右側に置いてあるプラ片）は **一方向ドア** として使うので、アルファベット記号を書いておきます。タラップ部は水平にはせず、45度程度に軽く折り曲げておきます（脱出をできるだけ難しくするため）。

    <a id="org6d9b1f9"></a>

    {{< figure src="/trap-step2.jpg" caption="&#22259;4:  カット済みの入口" width="50%" >}}

4.  **ドアの取付け** ：これが一番手間がかかります。キリでドア部と本体に２つずつ２ミリ程度の穴を開け、それに6mmの **丸カン** （百均）を通します（図[5](#org72b117a)）。この時に、ラジオペンチが2個あると便利です。なおドア部の左右両縁はハサミで1mm程度カットします。工作精度が低くてもドアが本体と干渉しないようにするためです。

    <a id="org72b117a"></a>

    {{< figure src="/trap-step3-3.jpg" caption="&#22259;5:  入口に丸カンでドアをぶら下げる。" width="50%" >}}

5.  **最後の仕上げ** ：ドアが内側から外にスイングしないように細手の針金で **ストッパー** をつけます（図[6](#org7c60ab2)）。

    <a id="org7c60ab2"></a>

    {{< figure src="/trap-step4.jpg" caption="&#22259;6:  一方向ドアの完成形" width="50%" >}}

6.  **根巻き麻布とりつけ** ：図[1](#orgc170131)のように入口直下の胴回りに「根巻き麻布」をしばりつけます（注[^fn:4]）。
