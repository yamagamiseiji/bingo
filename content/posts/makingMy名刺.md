...
51275の紙サイズの詳細は図[1](#org9eb298b) を参照のこと。
...
上で指定されているパラメータの意味は、図[2](#org2531bbe)を参照のこと[ [出典](http://cns-guide.sfc.keio.ac.jp/2001/11/5/1.html) ]。
...
組版したA4シートの印刷イメージは図[3](#orgac7c602) のとおり。
...
3.  用紙のディメンションは図[1](#org9eb298b)参照
...
-   表面と裏面を並行して作成・編集できるのはすばらしい（図[4](#org835cb44) ）。けど、この表裏切替えボタンは、すべての作業が終わるまで目につかなかった（涙）（これも加齢のせい？）
