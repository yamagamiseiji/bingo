...
<span style="color: red"> 【お知らせ】2025/02/24に Android版の1byone health アプリが ver 3.0.2 にバージョンアップされました。 2025/02/28 現在、新バージョンでどうやってCSV データをエクスポートするのか良く分かりません。 とりあえず一つ前のバージョン ver 2.3.1に戻して使用中です。</span>
