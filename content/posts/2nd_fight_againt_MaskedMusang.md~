...
大学を定年退職する際に、ほとんどの私物は廃棄したり、訪ねてきた卒業生の方たちにgive awayしましたが、荷造りして大事に持ち帰った少数の物品のなかの１つが図[1](#orge8803fa)
...
まずはニンニクを **スライサー** で薄切りにします。ところがこれが意外と大変で、とくに最初はうまく行かずイライラしました。それでも、包丁で刻んだりスライスするよりはマシかと思い直し、がまんして作業を続けました。最後になってようやくコツがつかめて、スムーズに作業が進むようになりました。図[2](#orgcec8725)はボウルにためたニンニクです。

<a id="orgcec8725"></a>

{{< figure src="/garlic_in_bowl.jpg" caption="Figure 2: ボウルにためたスライス済みニンニク" width="80%" >}}

これを蚊取り線香容器に詰めていきます。図[3](#orgdff5305)のような感じ。一見、美味しそうに見えますが結構臭いがきつく目がシバシバしますｗ

<a id="orgdff5305"></a>

{{< figure src="/garlic_in_case2.jpg" caption="Figure 3: 蚊取り線香容器に詰めたニンニク" width="80%" >}}

多少てんこ盛りに盛っても容器の白いマット（不燃性のガラス繊維）がうまくニンニクをホールドしてくれます。またこの容器はフタの **ロック機構** もすぐれもの。楽にパチンとしまります。完成品は図[4](#orgf5dd66a)の通りです。外から見たら、フツーの蚊取り線香。中にニンニクがぎっしり詰まっているとは思えませんｗ

<a id="orgf5dd66a"></a>

{{< figure src="/g_kanseihin.jpg" caption="Figure 4: ニンニク臭発散器の完成品" width="80%" >}}

さて、完成した発散器の置き方ですが、基本的には図[5](#org20437c9)のようにマルチの中央、トマトの株元にポンポンと置いていきます。

<a id="org20437c9"></a>

{{< figure src="/garlic_on_the_ground.jpg" caption="Figure 5: マルチの上にじか置きした発散器" width="80%" >}}

トンネルの両端に近いところでは、上のような置き方をすると、雨が降ったら水浸しになってしまいます。そこで、図[6](#org7bbd178)のようにヒモで吊り下げておきます。手前の白っぽい点々は1週間前の **8月3日** に撒き散らしたニンニクです。
...
という成功体験記憶が蘇ったので、 **8月2日** の昼間、エスプレッソマシン（図[1](#orge8803fa)）から出たコーヒーカスをボウルに半分ほどマルチの一箇所にドサッとまいておきました。
