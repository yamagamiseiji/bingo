...
DIYで自作したデッキ階段の図面を書くために2025年10月から [Sketchup Free](https://app.sketchup.com/app?hl=en) を使い始めました。この記事は Sketchupで **階段の踏板** の隠しビスの ****斜め打ち**** （図[1](#figure--tread-o-stair)の手前のビス4本）を書く方法を自分のための備忘として書いたものです。
...
Sketchup 初心者にとっては図[1](#figure--tread-o-stair)のような **隠しビスの斜め打ち** を書くのは容易ではありませんでした。
Sketchup **PRO** ならエレガントな方法がある？かもしれないし、 **Free** でも別の正解があると思います。一つの素朴なサンプルとしてご覧ください。

ちなみに今回作製した **階段踏板の概要** は次のとおりです。

-   踏板は 2x4 を3枚並べる。土台の枠も2x4[^fn_why2x4]
-   踏板を長持ちさせるために、ネジ穴に雨や日が直接当らないようにした
-   踏板同士の横連結には、40mmの **四角穴付き木ネジ** を水平穴に埋め込んで使用
-   踏板と土台の連結には、75mmの **コーススレッド** を斜めの隠し穴に10mmほど埋め込む
