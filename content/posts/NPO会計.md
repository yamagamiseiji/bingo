...
- [ポスティング サンプル](#ポスティング-サンプル)
    ...
    - [受取補助金の例](#受取補助金の例)
    - [事業収入の例](#事業収入の例)
    - [経常経費(Expenses）の例](#経常経費expenses-の例)
    - [源泉税の例](#gensenzei)
    - [立替金の例](#立替金の例)
    - [未払金の例](#未払金の例)
    - [仮受金の例](#仮受金の例)
...
{{< figure src="/cutdown-expenses-tree.svg" caption="<span class=\"figure-number\">&#22259;2:  </span>経常経費科目のサブ勘定科目" width="45%" >}}
...
****(10)**** 学術大会の講師謝金を新宿花子氏のゆうちょ口座に振り込んだ。<br />
